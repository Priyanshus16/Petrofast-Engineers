...
import img1 from "../component/Mlogo/pr11-image1.png"



export default function Productrange11(){
    return(
        <>
        {/* header */}
        <Header/>
        ...
        <center>
            <div className="product-range">
                ...
                <div className="heading2">Pipe Clamps </div>
                <div className="product-box-container">
                    <div className="product-box">
                        <div className="product-title">Pipe Clamps</div>
