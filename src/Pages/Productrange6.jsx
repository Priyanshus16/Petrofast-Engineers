...
import img1 from "../component/Mlogo/pr6-image1.png"
import img2 from "../component/Mlogo/pr6-image2.png"


export default function Productrange6(){
    return(
        <>
        {/* header */}
        <Header/>
        ...
        <center>
            <div className="product-range">
                ...
                <div className="heading2">All Threaded Studs </div>
                <div className="product-box-container">
                    <div className="product-box">
                        <div className="product-title">Threaded Studs</div>
